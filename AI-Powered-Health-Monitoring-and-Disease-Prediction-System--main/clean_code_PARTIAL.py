...
w2 = Label(root, justify=LEFT, text="Leave The Symptoms", fg="white", bg="black")
...
dst = Button(root, text="DecisionTree", command=exit,bg="green",fg="yellow")
dst.grid(row=8, column=3,padx=10)

rnf = Button(root, text="Randomforest", command=exit,bg="green",fg="yellow")
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="NaiveBayes", command=exit,bg="green",fg="yellow")
